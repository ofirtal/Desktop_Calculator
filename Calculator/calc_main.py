...
Type_box = Entry(root, width=35, borderwidth=5)
Type_box.grid(row=0, column=0, columnspan=3, padx=20, pady=3)


def button_click(number):
    current = Type_box.get()
    Type_box.delete(0, END)
    Type_box.insert(0, str(current) + str(number))
